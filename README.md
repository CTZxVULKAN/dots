...
yay -c
```
* Some drivers might be uninstalled in the prosecess of debloating. It is advised to reinstall the drivers once more after debloating. This will be fairly quick as build files for the drivers will be stored in cache
